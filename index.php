...
<body class="bg-gray-50">
    <div class="flex h-screen">
        ...
        <aside class="w-64 bg-white shadow-lg p-4">
            ...
            <nav class="space-y-2">
                <a href="index.php" class="flex items-center space-x-2 p-2 bg-blue-50 text-blue-600 rounded-lg">
                ...
                <a href="documents.php" class="flex items-center space-x-2 p-2 hover:bg-gray-100 rounded-lg">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="favorites.php" class="flex items-center space-x-2 p-2 hover:bg-gray-100 rounded-lg">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="trash.php" class="flex items-center space-x-2 p-2 hover:bg-gray-100 rounded-lg">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <main class="flex-1 p-8 overflow-auto">
            ...
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex space-x-4">
                    <a href="upload-file.php" class="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 flex items-center">
